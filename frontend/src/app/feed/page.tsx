...
function FeedContent() {
  ...
  return (
    <>
      <h1 className="mb-6 text-3xl font-bold text-neutral-50">Feed</h1>
      ...
      <section className="mb-8 rounded-xl bg-neutral-900/80 border border-white/[0.06] p-6 backdrop-blur-sm shadow-card">
        ...
        <form onSubmit={handleCreatePost}>
          ...
          <textarea
            ...
            rows={4}
            className="w-full rounded-lg border border-white/[0.06] bg-neutral-900/50 px-4 py-3 text-sm text-neutral-100 placeholder:text-neutral-500 focus:border-primary-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-950"
                    ...
                    {address &&
                      post.author_address.toLowerCase() ===
                        ...
                        <button
                          ...
                          className="ml-4 shrink-0 rounded-md px-3 py-1.5 text-xs font-medium text-error-400 transition-colors hover:bg-error-500/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-950 disabled:opacity-50"
